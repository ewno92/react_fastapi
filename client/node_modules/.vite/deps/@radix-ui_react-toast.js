...
var $054eb8030ebde76e$export$f5d03d415824e0e = (props) => {
  ...
  const [toastCount, setToastCount] = (0, import_react14.useState)(0);
  const isFocusedToastEscapeKeyDownRef = (0, import_react14.useRef)(false);
  const isClosePausedRef = (0, import_react14.useRef)(false);
  return (0, import_react14.createElement)($054eb8030ebde76e$var$Collection.Provider, {
    scope: __scopeToast
  }, (0, import_react14.createElement)($054eb8030ebde76e$var$ToastProviderProvider, {
    scope: __scopeToast,
    label,
    duration,
    swipeDirection,
    ...
    onToastAdd: (0, import_react14.useCallback)(
      () => setToastCount(
        (prevCount) => prevCount + 1
      ),
      []
    ),
    onToastRemove: (0, import_react14.useCallback)(
      () => setToastCount(
        (prevCount) => prevCount - 1
      ),
      []
...
var $054eb8030ebde76e$export$6192c2425ecfd989 = (0, import_react14.forwardRef)((props, forwardedRef) => {
  ...
  const headFocusProxyRef = (0, import_react14.useRef)(null);
  const tailFocusProxyRef = (0, import_react14.useRef)(null);
  ...
  const getSortedTabbableCandidates = (0, import_react14.useCallback)(({ tabbingDirection }) => {
  ...
  return (0, import_react14.createElement)($5cb92bef7577960e$export$aecb2ddcb55c95be, {
    ref: wrapperRef,
    role: "region",
  ...
  }, hasToasts && (0, import_react14.createElement)($054eb8030ebde76e$var$FocusProxy, {
  ...
  }), (0, import_react14.createElement)($054eb8030ebde76e$var$Collection.Slot, {
    scope: __scopeToast
  }, (0, import_react14.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.ol, _extends({
    tabIndex: -1
  }, viewportProps, {
    ref: composedRefs
  }))), hasToasts && (0, import_react14.createElement)($054eb8030ebde76e$var$FocusProxy, {
...
var $054eb8030ebde76e$var$FocusProxy = (0, import_react14.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react14.createElement)($ea1ef594cf570d83$export$439d29a4e110a164, _extends({
    "aria-hidden": true,
    tabIndex: 0
  }, proxyProps, {
    ref: forwardedRef,
...
var $054eb8030ebde76e$export$8d8dc7d5f743331b = (0, import_react14.forwardRef)((props, forwardedRef) => {
  ...
  }, (0, import_react14.createElement)($054eb8030ebde76e$var$ToastImpl, _extends({
    open
  }, toastProps, {
    ref: forwardedRef,
...
var $054eb8030ebde76e$var$ToastImpl = (0, import_react14.forwardRef)((props, forwardedRef) => {
  ...
  const pointerStartRef = (0, import_react14.useRef)(null);
  const swipeDeltaRef = (0, import_react14.useRef)(null);
  const duration1 = durationProp || context.duration;
  const closeTimerStartTimeRef = (0, import_react14.useRef)(0);
  const closeTimerRemainingTimeRef = (0, import_react14.useRef)(duration1);
  const closeTimerRef = (0, import_react14.useRef)(0);
  ...
  const startTimer = (0, import_react14.useCallback)((duration) => {
  ...
  const announceTextContent = (0, import_react14.useMemo)(() => {
  ...
  if (!context.viewport)
    return null;
  return (0, import_react14.createElement)(import_react14.Fragment, null, announceTextContent && (0, import_react14.createElement)($054eb8030ebde76e$var$ToastAnnounce, {
    __scopeToast,
    role: "status",
    "aria-live": type === "foreground" ? "assertive" : "polite",
    "aria-atomic": true
  }, announceTextContent), (0, import_react14.createElement)($054eb8030ebde76e$var$ToastInteractiveProvider, {
    scope: __scopeToast,
    onClose: handleClose
  }, (0, import_react_dom4.createPortal)((0, import_react14.createElement)($054eb8030ebde76e$var$Collection.ItemSlot, {
    scope: __scopeToast
  }, (0, import_react14.createElement)($5cb92bef7577960e$export$be92b6f5f03c0fe9, {
    asChild: true,
  ...
  }, (0, import_react14.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.li, _extends({
...
var $054eb8030ebde76e$var$ToastAnnounce = (props) => {
  ...
  const context = $054eb8030ebde76e$var$useToastProviderContext($054eb8030ebde76e$var$TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = (0, import_react14.useState)(false);
  const [isAnnounced, setIsAnnounced] = (0, import_react14.useState)(false);
  ...
  return isAnnounced ? null : (0, import_react14.createElement)($f1701beae083dbae$export$602eac185826482c, {
    asChild: true
  }, (0, import_react14.createElement)($ea1ef594cf570d83$export$439d29a4e110a164, announceProps, renderAnnounceText && (0, import_react14.createElement)(import_react14.Fragment, null, context.label, " ", children)));
};
var $054eb8030ebde76e$var$TITLE_NAME = "ToastTitle";
var $054eb8030ebde76e$export$16d42d7c29b95a4 = (0, import_react14.forwardRef)((props, forwardedRef) => {
  const { __scopeToast, ...titleProps } = props;
  return (0, import_react14.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, titleProps, {
    ref: forwardedRef
  }));
});
...
var $054eb8030ebde76e$export$ecddd96c53621d9a = (0, import_react14.forwardRef)((props, forwardedRef) => {
  const { __scopeToast, ...descriptionProps } = props;
  return (0, import_react14.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, descriptionProps, {
    ref: forwardedRef
  }));
});
...
var $054eb8030ebde76e$export$3019feecfda683d2 = (0, import_react14.forwardRef)((props, forwardedRef) => {
  const { altText, ...actionProps } = props;
  if (!altText)
    return null;
  return (0, import_react14.createElement)($054eb8030ebde76e$var$ToastAnnounceExclude, {
    altText,
    asChild: true
  }, (0, import_react14.createElement)($054eb8030ebde76e$export$811e70f61c205839, _extends({}, actionProps, {
    ref: forwardedRef
  })));
});
...
var $054eb8030ebde76e$export$811e70f61c205839 = (0, import_react14.forwardRef)((props, forwardedRef) => {
...
var $054eb8030ebde76e$var$ToastAnnounceExclude = (0, import_react14.forwardRef)((props, forwardedRef) => {
